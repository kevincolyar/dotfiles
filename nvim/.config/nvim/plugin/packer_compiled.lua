...
_G.packer_plugins = {
  ...
  ["doom-one.nvim"] = {
    loaded = true,
    path = "/Users/kevinc/.local/share/nvim/site/pack/packer/start/doom-one.nvim",
  ...
  ["lualine.nvim"] = {
    ...
    loaded = true,
    path = "/Users/kevinc/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-nvim-lsp" },
