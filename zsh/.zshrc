...
# Host modules (is-kevinc, mini, kubi): generated by nix/.config/nix/keychain.nix.
# Absent on hosts that do not import it; keys and flags are defined there, not here.
_keychain_zsh=${XDG_CONFIG_HOME:-$HOME/.config}/zsh/keychain.zsh
